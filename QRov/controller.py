from QRov.QCamera.flir import QFlirCamera
import json
...
class QRovController(QObject):
    ...
    def __init__(self, path: str, parent=None) -> None:
        ...
        with open(configFilePath, 'r') as configYaml:
            ...
            self.__flirCamera = self.__init_flir()
    ...
    def __init_flir(self) -> QFlirCamera:
        flir = QFlirCamera()
        flir.signals.acquired.connect(self.__on_cameraImageAcquired)
    ...
    @property
    def flir(self) -> typing.Optional[QFlirCamera]:
        return self.__flirCamera if self.configured else None
